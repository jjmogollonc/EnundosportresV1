				...
				<div class='col-md-4'>
							<div class='panel panel-info'>
								...
								<div class='panel-body'>
									...
									<div class='panel-heading'>Contenido: <br>$pro_desc</div>
								</div>
...
if(isset($_POST["get_cart_product"]) || isset($_POST["cart_checkout"])){
	...
	if($count > 0){
		...
		while($row=mysqli_fetch_array($run_query)){
			...
			if(isset($_POST["get_cart_product"])){
				...
				<div class='row'>
					...
					<div class='col-md-3 col-xs-3'><img src='product_images/$pro_image' width='80px' height='50px'></div>
		...
		echo '
				...
				echo   '
				<input type="hidden" name="return" value="http://localhost/enundosportres/payment_success.php"/>
				<input type="hidden" name="cancel_return" value="http://localhost/enundosportres/cancel.php"/>
